...
import os
import getpass
#dotenv.load_dotenv(path='/Users/lrao9/Desktop/LLM-Proj/HuggingFace-Ex/.env')
print("Dotenv at",find_dotenv())
load_dotenv(find_dotenv())
print()
print(os.environ['DB_HOST'])  # Output: localhost
print(os.environ['DB_USER'])  # Output: myuser
print(os.environ['DB_PASSWORD'])  # Output: mypassword
...
class Researcher:
    ...
    def search_articles(self, query):
        ...
        print("ApiENvKey",os.getenv("SERPER_API_KEY"))
        print("ApiKey",self.serper_api_key)
        headers = {
    ...
    def research(self, query):
        ...
        print("search_articles is" ,search_articles)
